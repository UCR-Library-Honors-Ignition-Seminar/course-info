...
4. **Submit on Canvas** — paste your GitHub repo URL (or GitHub Pages URL for hosted projects) into that week's Canvas assignment.
...
| Component | Weight |
|-----------|--------|
| Weekly Projects × 8 | 40% |
| Weekly Reflections × 8 | 16% |
| GitHub Portfolio Snapshot (end of Week 8) | 14% |
| Final Project | 20% |
| Final Presentation or Poster | 10% |
